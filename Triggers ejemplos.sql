...
BEGIN
    ...
    ELSIF UPDATING THEN
        ...
        V_FECHA_MODIFICACION := SYSDATE;
    END IF;
    INSERT INTO TELEFONOS_BIT (ID_TELEFONO_BIT, ID_TELEFONO, ID_CLIENTE, FECHA_CREACION, FECHA_MODIFICACION, ACCION, IP)
        VALUES (SEC_ID_TELEFONO_BIT.NEXTVAL, :NEW.ID_TELEFONO, :NEW.ID_CLIENTE,
        V_FECHA_CREACION, V_FECHA_MODIFICACION, V_ACCION, FN_GET_IP);
END;
